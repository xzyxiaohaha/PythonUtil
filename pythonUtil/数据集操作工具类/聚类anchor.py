...
def parse_label_txt(label_path):
    ...
    for i in range(len(all_label)):
        ...
        full_image_name = r"F:\pycharm-workspace\fireDataset\images2/" + label_name + '.jpg'
...
if __name__ == '__main__':
    # 读取 json 格式的标注数据
    # label_path = "F:\pycharm-workspace\selfCreateDataset_\coco_data_/instances_train.json"
    # label_result = parse_label_json(label_path)

    # 读取 txt 格式的标注数据
    label_path = r"F:\pycharm-workspace\fireDataset\labels2/"    # seed/images/ 内是对应图片文件
