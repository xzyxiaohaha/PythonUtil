...
def post_process(detect_results, part_number, qty, part_name_cn):
    '''
    detect_results = [[{'label': 'T26_ganlanhui_hei', 'score': 0.9432156682014465, 'boundary': [1132, 811, 1741, 1197]},
                       {'label': '360', 'score': 0.8651790618896484, 'boundary': [1500, 987, 1571, 1053]}],
                      [{'label': 'no_arabic', 'score': 0.9063203930854797, 'boundary': [360, 696, 886, 1251]}]]
    part_number = {'造型': '橄榄灰外后视镜', '360': '有', 'arabic': '无', '照地灯': '无', '零件号': '601000478AAAUD'}
    '''
    part_number_raw = eval(part_number)


    # 颜色编码对应: 根据part_number中的零件号确定其对应的label
    colorcode_dict = {
        "AAAUD": "ganlanhui",  # 橄榄灰
        "AAAUF": "haiyanhui",  # 海岩灰
        "AAAKV": "yizeyin",  # 依泽银
