...
if __name__ == '__main__':
    detect_results = [[{'label': 'T26_ganlanhui_hei', 'score': 0.9706354737281799, 'boundary': [1072, 498, 1858, 1018]},
      {'label': '360', 'score': 0.8995456099510193, 'boundary': [1523, 745, 1619, 831]}], []]
    part_number = {'造型': '橄榄灰外后视镜', '360': '有', 'arabic': '无', '照地灯': '无', '零件号': '601000480AAAUD'}
